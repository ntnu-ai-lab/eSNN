import argparse
import sys
from utils.plotting import readJson, plotNRealTrainings
...
def main():
    ...
    parser.add_argument('--showevals', metavar='showevals', type=str2bool,
                        help='Use evaluation rather than epochs for x axis.', default=False)
    ...
    plotNRealTrainings(json, save_directory, filename, args.font_scale,
                       args.removeoptimizer,
                       oldargs.showevals or args.showevals,
                       oldmethods, datasetsize, args.hue_order.split(","))
